...
public class GLRenderer4aProjectionMatrix implements GLSurfaceView.Renderer{
    ...
    public GLRenderer4aProjectionMatrix(Context context) {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        // set openGL matrix
        GLES20.glUniformMatrix4fv(uniformLocationMatrix, 1, false, projectionMatrix, 0);
